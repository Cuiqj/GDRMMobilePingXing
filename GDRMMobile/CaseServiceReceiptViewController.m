...
- (void)pageLoadInfo{
    ...
    //self.textreason.text = [NSString stringWithFormat:@"%@%@", citizen.automobile_number, proveInfo.case_short_desc];
    self.textreason.text = @"交通事故损坏公路路产";
    ...
    self.textservice_company.text = [[self.textservice_company.text
                                      stringByReplacingOccurrencesOfString: @"三中队" withString: @"" ] stringByReplacingOccurrencesOfString: @"四中队" withString: @"" ];
