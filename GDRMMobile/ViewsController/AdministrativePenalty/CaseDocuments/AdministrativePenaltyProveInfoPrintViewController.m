...
//    self.textMark3.text = caseInfo.full_case_mark3;
    ...
    if(chunks && [chunks count]>=2)
    {
        ...
        self.textprover1_duty.text = [self TextpeoverDutyNsstringName:self.textprover1.text];
        
        //勘验人2 单位职务
        self.textprover2.text = [chunks objectAtIndex:1];
        self.textprover2_duty.text = [self TextpeoverDutyNsstringName:self.textprover2.text];
    }
    else
    {
    ...
    self.textrecorder_duty.text = [self TextpeoverDutyNsstringName:self.textrecorder.text];
...
- (void)setUser:(NSString *)name andUserID:(NSString *)userID{
    if (self.textFieldTag == 200) {
        ...
        self.textprover1_duty.text =[self TextpeoverDutyNsstringName:name];
//        UserInfo orgAndDutyForUserName:name];
    }else if (self.textFieldTag == 201){
        self.textprover2.text = name;
        self.textprover2_duty.text = [self TextpeoverDutyNsstringName:name];
//        [UserInfo orgAndDutyForUserName:name];
    }else if (self.textFieldTag == 202){
        self.textrecorder.text = name;
        self.textrecorder_duty.text =[self TextpeoverDutyNsstringName:name];
//        [UserInfo orgAndDutyForUserName:name];
    }
}
