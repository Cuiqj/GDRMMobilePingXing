...
-(IBAction)textSelectMuban:(UITextField *)sender{
    ...
    [self pickerPresentForIndex:6 fromRect:sender.frame];
}
...
-(NSString*)generateCommonInquireText{
    ...
    organizationName = [[organizationName stringByReplacingOccurrencesOfString:@"三中队" withString:@""]stringByReplacingOccurrencesOfString:@"四中队" withString:@""];
