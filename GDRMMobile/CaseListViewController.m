...
- (void)awakeFromNib{
    [super awakeFromNib];
    self.preferredContentSize = CGSizeMake(350, 500);
}
- (void)viewDidLoad{
    ...
    [fetchRequest setPredicate:[NSPredicate predicateWithFormat:@"case_mark2 != nil && case_mark3 != nil && case_type_id == %@ && isdowndata != YES",self.caseType]];
    NSError *error;
